      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 text-gray-900 w-48"
          />
          <button
            ...
            {paged.length === 0 ? (
              <tr>
                <td colSpan={6} className="px-6 py-12 text-center">
                  ...
                  <p className="text-gray-500">{search ? 'No products match' : 'No products yet'}</p>
                </td>
              </tr>
            ) : (
              paged.map((product) => (
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-900 font-medium">{product.quantity}</td>
                  <td className="px-6 py-4">
                    <span
        ...
        <div className="flex items-center justify-between mt-4 px-2">
          ...
          <div className="flex gap-2">
            <button onClick={() => setPage((p) => Math.max(1, p - 1))} disabled={page === 1}
              className="px-3 py-1 rounded-lg bg-gray-200 text-gray-700 text-sm disabled:opacity-40 hover:bg-gray-300">← Prev</button>
            ...
            <button onClick={() => setPage((p) => Math.min(totalPages, p + 1))} disabled={page === totalPages}
              className="px-3 py-1 rounded-lg bg-gray-200 text-gray-700 text-sm disabled:opacity-40 hover:bg-gray-300">Next →</button>
          </div>
        </div>
      )}
      </> ) })()}
